...
This is the step that separates a library from a pile. Before writing, compare the new material against what is already there. For every fact that touches something existing (a price, a term, a position, a role), decide:

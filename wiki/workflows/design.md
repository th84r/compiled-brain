...
5. **Content is moved to the archive and kept.** Auditability over tidiness.
...
The hats, the quality filter in `CLAUDE.md`, and the voice rules. Leave invariant 3 alone. It is what keeps a derived conclusion from reading as a verified fact.
